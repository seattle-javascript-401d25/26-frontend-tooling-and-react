...
class App extends React.Component {
  ...
  handleCounterIncrement = () => {
    ...
    // we don't want to modify the state directly via "this.state.someProp = something else". React does not like this and it will not re-render your component. Read more here: https://reactjs.org/docs/state-and-lifecycle.html
